...
function Footer() {
    return (
        <div className='bg-orange-400 mt-3'>
            <div style={{marginLeft: '265px', marginRight: '90px'}} className="mt-10 text-white flex justify-between items-center">
                <div className="rt flex flex-col items-start justify-around mx-8 mt-10" style={{width: "244%"}}>
                    ...
                    <div className="map mb-8">
                        <img style={{width:"445px"}} src={mapImage} alt="map" />
                    </div>
                </div>
